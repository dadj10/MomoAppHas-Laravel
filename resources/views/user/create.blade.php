...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-10">
            ...
            <div class="card">
                <div class="card-header">{{ __('Formulaire de création d\'utilisateur') }}</div>
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('users.store') }}" autocomplete="off">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="name" type="text" class="form-control @error('name') is-invalid @enderror" name="name" value="{{ old('name') }}" required autocomplete="name" placeholder="Nom et Prénoms" autofocus>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <select class="form-control @error('role_id') is-invalid @enderror" id="role_id" name="role_id" required autofocus>
                                    <option value="">[Roles utilisateur]</option>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="password_confirmation" type="password" class="form-control" name="password_confirmation" required autocomplete="new-password" placeholder="Confirmez le mot de passe">
                            </div>
                        </div>
